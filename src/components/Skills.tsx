...
const Skills: React.FC = () => {
  ...
  const skillCategories = [
    {
      ...
      skills: ["Python (numpy, pandas, scikit-learn, scipy, dash, streamlit, etc.)", "SQL (Redshift, BigQuery, MySQL)", "Jupyter Notebooks", "ETL"],
      icon: (
    ...
    {
      category: "Cloud & AWS",
      skills: ["AWS QuickSight", "AWS S3", "AWS Lambda", "AWS EC2", "AWS Glue", "BigQuery", "Cloud Infrastructure", "Docker", "Kubernetes"],
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      skills: ["QuickSight", "PowerBI", "Tableau", "Data Visualization", "Dashboard Development", "Data Storytelling", "KPI Reporting"],
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      skills: ["Asana", "JIRA", "Agile Methodologies", "Cross-functional Team Leadership", "Project Planning", "Stakeholder Management", "Risk Management", "Budgeting", "Resource Allocation"],
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const competencies = [
    ...
    },
    {
      ...
      description: "Supply chain optimization, demand forecasting, inventory management, process automation, and data-driven efficiency improvements",
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Cross-functional team management, mentoring, stakeholder collaboration, logistics operations, and warehouse management"
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
